	...
	return (
		<>
			<div className='fixed xl:top-100 top-5 xl:right-10 right-5 z-40 flex flex-col items-end'>
				<button className=" bg-slate-100 p-4 rounded-full w-fit cursor-pointer select-none text-3xl flex xl:flex-row flex-col xl:items-center items-start align-center text-black z-40" onClick={() => setIsOpen(!isOpen)}>
				...
				{isOpen && (
					<>
						...
						<div className="w-fit h-fit bg-slate-100 p-4 mt-3 rounded-xl text-center">
